...
float4 frag(g2f i) : SV_Target
{
    ...
    {
        return float4(_BaseColor.rgb * _Emission,0);
    }

    // Smooth our line out
    float t = exp2(_WireSmoothness * -1.0 * minDistanceToEdge * minDistanceToEdge);
    float4 finalColor = lerp(_BaseColor, _WireColor, t);
    finalColor = float4(finalColor.r * _Emission, finalColor.g * _Emission, finalColor.b * _Emission, finalColor.a);
